...
func TestSetBridge_DoesNotPanic(t *testing.T) {
	t.Parallel()

	// SetBridge stores the bridge but QuickChat doesn't use it
	// (chat uses session.Run directly; bridge is for Execute).
